...
public class Practice12MeasureTextView extends View {
...

    {
        ...
        wightText1 = paint1.measureText(text1);
        wightText2 = paint2.measureText(text2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text2, 50 + wightText1, 200, paint2);
        canvas.drawText(text3, 50 + wightText1 + wightText2, 200, paint1);
    }
}
